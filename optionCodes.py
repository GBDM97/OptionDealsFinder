...
def write():
    ...
    for i in testList:
        arr.append({'code':i})
        calls = assetOptionsToList(i)[0]
        puts = assetOptionsToList(i)[1]
        [arr.append({"code":i[:4]+ii[0],"strike":ii[3]})for ii in calls]
        [arr.append({"code":i[:4]+ii[0],"strike":ii[3]})for ii in puts]
